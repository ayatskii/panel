...
const TemplateCreatePage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(apiError.data?.message || 'Failed to create template')
    }
  }
  ...
  return (
    <Box>
      ...
      <Alert severity="info" sx={{ mb: 3 }}>
        <strong>Admin Feature:</strong> Templates define the structure and design for your websites.
        Choose between Monolithic (fixed structure) or Sectional (modular components).
      </Alert>
